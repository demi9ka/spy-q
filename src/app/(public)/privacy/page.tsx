    ...
    <Section className='max-w-[1100px]   pt-[120.0px] md:pt-[57.6px] lg:pt-[73.6px] xl:pt-[92.0px] 2xl:pt-[120.0px]  pb-33 md:pb-14'>
      ...
      <Container className='mt-[24.0px] md:mt-[11.5px] lg:mt-[14.7px] xl:mt-[18.4px] 2xl:mt-[24.0px]'>
        ...
        >
          ...
          <br />
          Система генерирует интеллектуальные оповещения с указанием вашего ресурса, которые отображаются в статистике и
          службах мониторинга целевых сайтов. Это обеспечивает естественную видимость бренда и прямой трафик.
          <br />
