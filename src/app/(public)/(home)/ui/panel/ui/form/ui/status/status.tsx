...
export const Status = observer(() => {
  ...
  const isButtonActive = status == 2 || Boolean(mailingId)
  return (
    <button
      onClick={onPress}
      type='submit'
      className={`flex flex-col justify-between h-30 md:h-auto  border-2 border-accent   grow-[2] ${
        isButtonActive && 'bg-accent cursor-pointer'
      }  
